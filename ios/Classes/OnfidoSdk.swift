...
public func loadAppearanceFromConfig(config: NSDictionary) throws -> Appearance {
    ...
    if let appearancePublic = appearancePublic {
        ...
        appearence.primaryColor = appearancePublic.primaryColor;
        appearence.primaryTitleColor = appearancePublic.primaryTitleColor;
        appearence.primaryBackgroundPressedColor = appearancePublic.primaryBackgroundPressedColor;
        appearence.supportDarkMode = appearancePublic.supportDarkMode;
        
        return appearence;
    } else {
        return Appearance.getDefault();
    }
}
...
extension Appearance {
    ...
    static func getDefault() -> Appearance {
